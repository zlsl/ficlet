...
// --Commented out by Inspection START (16.07.20 22:31):
...
//        m_charset = SystemCharset.defaultCharset();
//    }
// --Commented out by Inspection STOP (16.07.20 22:31)
    ...
    public int hashCode() {
        if (m_hashCode == 0) {
            int multiplier = 1;
            int offset = m_offset;
            for (int i = offset + m_length - 1; i >= offset; i--) {
                m_hashCode += m_buffer[i] * multiplier;
